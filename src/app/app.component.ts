...
export class AppComponent implements OnInit, OnDestroy {
  ...
  initLoadingState(): void {
    ...
    const combinedLoaderSubscription$ = combineLatest([charactersLoader$, planetLoader$])
        .subscribe((loadingElements) => {
          this.isLoading = this.areAllValuesTrue(loadingElements);
        })
    this.subscriptions.push(combinedLoaderSubscription$);
    // YOUR CODE ENDS HERE
  }
